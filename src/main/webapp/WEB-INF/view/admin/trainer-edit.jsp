		...
		<main>
			<div class="container">
				...
				<div class="row">
					...
					<form:form id="saveForm" action="${pageContext.request.contextPath}/user/admin/trainers/edit" 
							modelAttribute="trainer" method="post" cssClass="form-group col-sm-12 col-4">
						<jsp:include page="/WEB-INF/view/components/trainer/info-edit.jsp"/>	
					</form:form>
				</div>
