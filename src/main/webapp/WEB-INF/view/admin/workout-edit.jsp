		...
		<main>
			<div class="container">
				...
				<div class="row">	
					...
					<form:form id="saveForm" action="${pageContext.request.contextPath}/user/admin/workouts/edit" modelAttribute="workout" 
						method="post" cssClass="form-group col-sm-12 col-4">
						<form:hidden path="id"/>
						<jsp:include page="/WEB-INF/view/components/workout/info.jsp"/>
					</form:form>
				</div>
