				...
				<div class="row">
					...
					<c:choose>
						<c:when test="${trainersToBe.size()!=0}">
							...
							<form:form id="saveForm" action="${pageContext.request.contextPath}/user/admin/trainers/add" modelAttribute="newTrainer" method="post">
								
								<table>
									<tbody>
										<tr>
											<td><label>Wybierz użytkownika: </label></td>
											<td>
