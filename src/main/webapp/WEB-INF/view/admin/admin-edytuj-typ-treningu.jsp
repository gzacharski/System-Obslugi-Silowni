...
<sql:query var="listWorkouts" dataSource="jdbc/webgymsystem">
        select * from workouts where workout_id=${param.id};
</sql:query>
			...
			<article>
				<section>
					<div id="container" style="height: auto; margin-bottom: 20px;">
						...
						<form action="Admin" method="post" id="edit_place">
							<input type="hidden" name="command" value="EDIT_WORKOUT"/>
								...
								<table>
									<tbody>
										<tr>
											...
											<td><input type="text" name="typeOfWorkout" value="${workout.type_of_workout}"/></td>
										</tr>
										<tr>
											<td><label>Opis: </label></td>
											<td><textarea name="description" rows="4" cols="80" maxlength="255" minlength="10">${workout.description}</textarea></td>
										</tr>
										<tr>
											<td><label>Zdjęcie: </label></td>
											<td><input type="text" name="image" value="${workout.image}"/></td>
										</tr>
										<tr>
											<td><label>Czas trwania treningu: </label></td>
											<td><input type="time" name="duration" step="1" value="${workout.duration}"></td>
										</tr>
									</tbody>
								</table>
