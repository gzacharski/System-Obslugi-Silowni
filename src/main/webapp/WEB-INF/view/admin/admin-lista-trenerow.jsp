					...
					<div id="container" style="height: auto; margin-bottom: 20px;">
						...
						<table border="1" cellpadding="5" style="width: 100%">
				            ...
				            <c:forEach var="trainer" items="${listTrainers.rows}">
				                <tr>
				                    <td><c:out value="${trainer.trainer_id}" /></td>
				                    <td><c:out value="${trainer.name}" /></td>
				                    <td><c:out value="${trainer.surname}" /></td>
				                    <td><a style="color:white;" href="admin-edytuj-trenera.jsp?id=<c:out value="${trainer.trainer_id}" />">Kliknij</a></td>
				                </tr>
				            </c:forEach>
				        </table>
						<div style="clear:both;"></div>
						<div class="button">
							<form action="Admin" method="post"> 
								<input type="hidden" name="command" value="SHOW_ADD_TRAINER"/>
								<input type="submit" value="Dodaj trenera" class="tileButton">
							</form>
						</div>
						<div class="button">
