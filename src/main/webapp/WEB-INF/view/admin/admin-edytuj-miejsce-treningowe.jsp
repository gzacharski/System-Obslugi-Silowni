...
<sql:query var="listPlaces" dataSource="jdbc/webgymsystem">
        select * from places where place_id=${param.id};
</sql:query>
								...
								<table>
									<tbody>
										<tr>
											...
											<td><input type="text" name="placeName" maxlength="45" value="${place.place_name}"/></td>
										</tr>
										<tr>
											<td><label>Opis: </label></td>
											<td><textarea name="description" rows="4" cols="80" maxlength="255" minlength="10">${place.description}</textarea></td>
										</tr>
									</tbody>
								</table>
