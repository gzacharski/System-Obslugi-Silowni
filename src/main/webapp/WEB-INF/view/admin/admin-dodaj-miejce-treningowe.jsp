			...
			<article>
				<section>
					<div id="container" style="height: auto; margin-bottom: 20px;">
						...
						<form action="Admin" method="post" id="add_place">
							<input type="hidden" name="command" value="ADD_PLACE"/>
								<table>
									<tbody>
										<tr>
											<td><label>Nazwa miejsca treningowego: </label></td>
											<td><input type="text" name="placeName" maxlength="45"/></td>
										</tr>
										<tr>
											<td><label>Opis: </label></td>
											<td><textarea name="description" form="add_place" rows="4" cols="80" maxlength="255" minlength="10"></textarea></td>
										</tr>
									</tbody>
								</table>
							<div class="button">
