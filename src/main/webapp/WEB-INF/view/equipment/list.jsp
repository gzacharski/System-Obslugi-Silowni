		...
		<main>
			<div class="container">
				...
				<div class="d-flex justify-content-between col-12 my-2">
					<form:form action="${pageContext.request.contextPath}/user/equipments/add" method="get">
						<input type="submit" value="Dodaj sprzęt" class="btn btn-secondary float-left mx-2">
					</form:form>
					
					<form:form action="${pageContext.request.contextPath}/user/equipments/search" method="get" cssClass="input-group">
						<div class="input-group-prepend">
							 <span class="input-group-text" id="basic-addon1">
							   <jsp:include page="/WEB-INF/view/components/bootstrap-icons/search.jsp"/>
							</span>
						</div>
						<input type="text" name="searchedPhrase" placeholder="Szukaj sprzętu" class="form-control">
